...
export type ToasterContainer =
  | React.FC<RHToasterProps>
  | ((props: RToasterProps) => React.JSX.Element)
  | ((props: SnToasterProps) => JSX.Element)
  | null;
...
export interface AxiosQueryConfig
  extends Omit<AxiosContextType, "axiosInstance" | "packageName"> {
...
export interface UseQueryProps<T, R> extends CommonQueryProps {
  ...
  queryKey: QueryKey;
  options?: Omit<
    UseQueryOptions<AxiosResponse<R>, Error, R>,
    "queryKey" | "queryFn"
  >;
}
export interface UseInfiniteQueryProps<R> extends CommonQueryProps {
  ...
  options?: Omit<
    UseInfiniteQueryOptions<R, Error>,
